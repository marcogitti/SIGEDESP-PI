...
class UnidadeConsumidoraPage extends StatelessWidget {
  UnidadeConsumidoraPage({Key? key}) : super(key: key);
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: const Text('Unidade consumidora'),
                            content: TextField(
                              controller: _controller,
                              decoration: const InputDecoration(
                                hintText: 'Nome da Unidade consumidora',
                              ),
                            ),
                            actions: <Widget>[
                              TextButton(
